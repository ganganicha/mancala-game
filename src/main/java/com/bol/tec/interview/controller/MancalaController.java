...
@RestController
@RequestMapping(value = "mancalagame")
public class MancalaController {
    ...
    public MancalaGameBoard createGame(@Valid @RequestBody GameCreateRequest gameBoardRequest) {
    ...
    public MancalaGameBoard playGame(@Valid @RequestBody GamePlayRequest gamePlayRequest) {
